...
if __name__ == "__main__":
	...
	testArticle = Article("asdfadf")
	testArticle.set_url("o")
	print(testArticle.get_url())

	# search_objs = pull_from_search()
	# feed_objs= pull_from_feeds()

	# for obj in search_objs:
	# 	extract_metadata(obj)
	# 	if is_uniq_article(obj) and is_valid_article(obj):
